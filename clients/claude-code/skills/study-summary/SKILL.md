...
1. Run `memcard decks ls` to get all decks with card counts and due counts.

2. Run `memcard review due` to get all due cards across decks.
...
4. Offer actionable suggestions:
   - If there are due cards, suggest starting a review with `/memcard:review`
